...
constexpr uint8_t TOUCH_REVERSE_PIN = 12;
...
constexpr uint16_t TOGGLE_THRESHOLD = 25;
constexpr uint16_t FORWARD_THRESHOLD = 34;
constexpr uint16_t REVERSE_THRESHOLD = 47;
